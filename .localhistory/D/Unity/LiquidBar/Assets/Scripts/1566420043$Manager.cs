...
public class Manager : MonoBehaviour
{
    ...
    public async void CallStartChoosing(GameObject customer)
    {
        Debug.Log(customer.transform.GetChild(1).gameObject.name);
        customer.transform.GetChild(1).gameObject.SetActive(false); /*Quitar customer chat*/
