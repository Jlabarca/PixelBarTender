...
public class CameraController : MonoBehaviour {
    ...
    private void FixedUpdate() {
        ...
        Vector3 newPosition = new Vector3(delta.x, delta.y, -1f);
        ...
        transform.position = Vector3.SmoothDamp(position, newPosition, ref velocity, cameraSmoothing * Time.deltaTime);
