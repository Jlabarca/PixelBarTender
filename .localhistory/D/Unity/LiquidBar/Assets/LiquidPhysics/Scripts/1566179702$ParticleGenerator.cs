...
public class ParticleGenerator : MonoBehaviour
{
    ...
    public Vector3 particleForce = new Vector3(); //Is there a initial force particles should have?
    public Vector3 particleStartPosition; //Is there a initial position
    ...
    void Update()
    {
        if(emit)
            ...
            { // Is it time already for spawning a new particle?
                ...
                newLiquidParticle.transform.position = newLiquidParticle.transform.position + particleStartPosition;
